...
- The energy data source of Malaysia to be used in this project is scrapped using API through [eia](https://www.eia.gov/international/analysis/country/MYS). Then, scrapped data will also be stored in MongoDB. 
...
- energy emission factors and other appropriate features are used for analyzing the energy consumption trends via machine learning algorithms to create a model that can forecast energy usage, recognize trends and discover anomalies.
...
• `Data collection:` To begin the project, the data relevant to the energy usage in Malaysia will be scrapped and collected through API from [eia](https://www.eia.gov/international/analysis/country/MYS).
...
• `Data source:` Data is collected and scrapped through API from <a href="[https://www.eia.io/data/explorer?search=energy-energy_source_grid_mix&region=MY]">eia</a>.
...
<table align=center>
   <tr>
    <td>Data source</td>
    <td><a href="[https://www.eia.io/data/explorer?search=energy-energy_source_grid_mix&region=MY]">eia</a></td>
   <tr>
   <tr>
...
#### 1) Data collection and integration
   ...
   Based on the goals of our dashboard, data is collected from the data explorer of eia. All relevant data will be scrapped and integrated in the dashboard.
...
<table>
  <tr>
    <th>Data sources</th>
    <td>
     Use data from <a href="[https://www.eia.io/data/explorer?search=energy-energy_source_grid_mix&region=MY]">eia data explorer</a>
   </td>
  </tr>
  <tr>
    <th>Data schema</th>
    <td>energy database in Malaysia</td>
  </tr>
  <tr>
