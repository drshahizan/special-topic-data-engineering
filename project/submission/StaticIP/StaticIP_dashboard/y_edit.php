...
$sql="SELECT * FROM tb_year 
    LEFT JOIN tb_product ON tb_year.y_product = tb_product.p_id
    LEFT JOIN tb_activity ON tb_year.y_activity = tb_activity.a_id
    LEFT JOIN tb_unit ON tb_year.y_unit = tb_unit.t_id	
    WHERE y_id = '$yid'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Yearly Data</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="y_editprocess.php" method="POST" enctype="multipart/form-data">

                            <div class="form-group">
								<label for="inputyid" class="form-label">ID</label>
								<?php
                                echo '<input class="form-control" type="text" name="yid" id="inputyid" value="'.$row['y_id'].'" readonly>'; 
                                ?>
							</div>

                            <div class="form-group">
                                <label for="inputyperiod" class="form-label">Period</label>
                                <?php
                                echo '<input class="form-control" type="text" name="yperiod" id="inputyperiod" value="'.$row['y_period'].'">'; 
                                ?>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputyvalue" class="form-label">Value</label>
                                <?php
                                echo '<input class="form-control" type="text" name="yvalue" id="inputyvalue" value="'.$row['y_value'].'">'; 
                                ?>
                            </div>
