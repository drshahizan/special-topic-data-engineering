    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="addcustomer.php" class="active">
            ...
            <div class="card-body">
              ...
              <form action="process_customer.php" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="spending_score" name="spending_score" required>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="work_experience" name="work_experience" required>
                </div>
