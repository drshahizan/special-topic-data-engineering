...
| Lab | Title | Description | Output |
| :-----: | ----- | :------ | :------: |
| 1   | Build A Google Gemini Chatbot with HTML CSS and JavaScript | AI chatbots like Google Gemini or ChatGPT have changed how we interact with technology, making conversations with machines almost human.| <a href="lab/chat1.md" ><img src="../images/task.png" width="24px" height="24px" ></a>|
