                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="form-group col-lg-6">
                                ...
                                <label for="inputvreg" class="form-label">ID: <?php echo $row['m_id'];?></label>
                                </div>

                            <div class="form-group">
                                <label for="inputvreg" class="form-label">Period: <?php echo $row['m_period'];?></label>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="inputvreg" class="form-label">Value: <?php echo $row['m_value'];?></label>
                            </div>
