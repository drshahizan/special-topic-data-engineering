...
<div class="container">
    ...
    <a class="button btn btn-primary btn-sm d-none d-sm-inline-block" id="formToggle" data-modal="modalOne" style="width: 10%;transform: perspective(0px) translate(21px);position: absolute;right: 1%;top: 20px;font-size: 15px;">Book a Car</a>

      <?php include 'customerbooking1.php';  ?>
