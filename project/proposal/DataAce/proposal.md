...
- i. Data Sources : The data which will be used in this project will be collected from Kaggle dataset. Other than that, the synthetic data will be generated by using Python.

- ii. Tools and Technologies : The dataset will be connected to MongoDB by using Tensorflow to do data pre-processing, training and testing data.
