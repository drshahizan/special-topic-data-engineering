          ...
          <a class="close" style="padding-right: 4%;">&times;</a>
                  <div class="w-100" style="padding-bottom: 6%;"></div>
                                    ...
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Book a Car!</h4>
                                    </div>

      <form class="form" method="POST" onsubmit="return formValidation()" action="customerbookingprocess.php">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <input type="date" name="fbdate" class="form-control form-control-user" id="InputBookingDate" placeholder="Create Strong Password" required>
          </div>

          <div class="form-group">
            <label for="InputReturnDate" class="form-label mt-4">Select Return Date</label>
            <input type="date" name="frdate" class="form-control form-control-user" id="InputReturnDate" placeholder="Enter your full name" required>
          </div>
                <!-- Time Error message --->
          ...
          <button type="submit" class="btn btn-info d-block btn-user w-100">Book</button>
